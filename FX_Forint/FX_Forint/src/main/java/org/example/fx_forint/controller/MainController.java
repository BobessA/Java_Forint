...
public class MainController {
    ...
    @FXML
    private void loadDetailedMNBLoaderToFile() {loadView("/org/example/fx_forint/downloadMNBExchange2-view.fxml");}
    @FXML
    private void loadMNBChart() {loadView("/org/example/fx_forint/Chart-view.fxml");}
    @FXML
